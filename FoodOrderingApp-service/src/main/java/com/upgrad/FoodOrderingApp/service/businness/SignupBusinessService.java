...
public class SignupBusinessService {
    ...
    public CustomerEntity signup(CustomerEntity customerEntity, String firstName,String lastName,String emailAddress,String contactNumber,String password ) throws SignUpRestrictedException {
        ...
        } else if (emailAddress.length()< 5) {//This code has to changed for correct problem statement
            throw new SignUpRestrictedException("SGR-002","Invalid email-id format!");
        } else if (contactNumber.length()!=5) {//This code has to changed for correct problem statement
            throw new SignUpRestrictedException("SGR-003","Invalid contact number!");
        }else if (password.length()<8) {//This code has to changed for correct problem statement
